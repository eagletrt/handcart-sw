function createMultilineChart(basicPath, name, param, zoom, label, u) {
    let NZ = "nozoom";
    ...
    am4core.ready(async function () {
        ...
        var data = [];
        var previousValue = -1;
        var firstItem = true;   // it's the first iteration in the loop
        ...
        for(let key in keys) {
            ...
            if(zoom != NZ) {
                ...
                updateMultilineChartValue(chart, lastPath, param, zoom, label);
