...
def GPIO_setup():
    ...
    GPIO.setup(PIN.BUT_0.value, GPIO.IN)
    GPIO.setup(PIN.BUT_1.value, GPIO.IN)
    GPIO.setup(PIN.BUT_2.value, GPIO.IN)
    GPIO.setup(PIN.BUT_3.value, GPIO.IN)
    GPIO.setup(PIN.BUT_4.value, GPIO.IN)
